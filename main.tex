...
\begin{figure}[!htbp]
    ...
    \caption{$A_0$, $S_0$, $A_1$, and $S_1$ group velocity dispersion curve shift with temperature from 20\si{\degreeCelsius} to 160\si{\degreeCelsius} for Aluminium 1050 H14.}\label{fig:grouptempshuftalu}
\end{figure}
...
\begin{figure}[!htbp]
    ...
    \caption{$S_0$ group velocity change with temperature from 20\si{\degreeCelsius} to 160\si{\degreeCelsius} at 1 MHz for Aluminium 1050 H14.}\label{fig:alu1mhz}
\end{figure}
...
\begin{figure}[!htb]
    ...
    \caption{Diagram of test setup and $S_0$ mode wave propagation.}\label{fig:testdiagram}
\end{figure}
...
\begin{figure}[!htb]
    ...
    \caption{Time of flight change with temperature when aluminium plate is cooled with freeze spray.}\label{fig:freeze}
\end{figure}
