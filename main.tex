...
Experimental measurements are underway on this mode. Initial studies indicate that only the $A_1$ mode is present.

\section{S1 mode (4 MHz-mm)}

Experimental measurements are planned in the near future for this mode. Initial studies indicate that this region of frequency-thickness is multi--modal and both the $A_1$ and $S_1$ modes will be present, due to similarities in phase velocity and excitation angle. This study will benefit from the use of short windowed pulses that will aide in separating the modes in the time domain.
