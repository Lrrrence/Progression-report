...
The wave velocity temperature sensitivity of three Lamb wave modes have been experimentally measured, to be validated against theoretical predictions.

Two 1 MHz piezoelectric transducers attached to acrylic wedges (Olympus variable angle wedge) in a pitch-catch configuration have been coupled to a 1~mm thick aluminium with a liquid couplant (Figures~\ref{fig:testdiagram} \&~\ref{fig:testsetup}). The wedges allow for careful selection of excitation angle so that modes of interest can be targeted. The angle is determined based on Snell’s law:
%
\begin{equation} 
...
\begin{itemize}
    ...
    \item COMSOL modelling of the experimental test system. The model will be used in future studies. This is addressed in Section~\ref{simulations}.
\end{itemize} 
...
\begin{itemize}
    \item The effect of plate holes on Lamb wave mode propagation will be investigated through simulation and experimentation. The ability to monitor temperature at a number of locations through the analysis of acoustic reflections will be explored. This will begin by analysing the effect of one hole on the wave propagation of different modes, before increasing the number of holes to more accurately represent a real nozzle guide vane.
    \item To operate at higher temperatures a new transducer configuration will be required. The most suitable option is to distance the transducers away from the high temperatures using waveguides, coupling into the test structure using a system of Hertzian contact points. COMSOL simulations will be used to investigate the potential of this method.
    ...
    \item A journal or conference paper submission will be prepared that focuses on the COMSOL~modelling and analysis of Lamb wave propagation. 
\end{itemize}
