...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{./figures/COMSOLpressure.png}
    \caption{COMSOL simulation of $S_0$ mode propagation in 1 mm thick aluminium plate}\label{fig:COMSOLpressure}
\end{figure}
...
\begin{itemize}
    \item The effect of plate holes on Lamb wave mode propagation can be investigated through simulation and experimentation. The ability to monitor temperature at a number of locations through the analysis of acoustic reflections can be investigated. 
    \item Investigate the possibility of exciting a single mode in area of high dispersion (e.g. steep group velocity curve) to maximise group velocity temperature sensitivity.
    ...
    \item COMSOL simulations can be used to investigate different transducer configurations. When a suitable configuration is found the response can be verified experimentally.
    \item COMSOL simulations of the chosen transducer configuration on an NGV structure (with curved surfaces and cooling holes)
\end{itemize}
