...
\begin{itemize}
    \item What is the impact of temperature on the wave velocity of Lamb wave modes?
    \item How can the temperature dependence of Lamb waves be utilised for temperature monitoring of NGVs?
    \item What is the effect of the physical environment on the temperature monitoring system?
\begin{itemize}
    \item Cooling holes
    \item Curved surfaces
\end{itemize}
    \item What is the most suitable transducer configuration for attaching to nozzle guide vanes?
\end{itemize}
  
\subsection{Plans from 18 month review onwards}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Conference paper ``Towards in-flight temperature monitoring for nozzle guide vanes using ultrasonic guided waves'' submitted to \href{https://www.aiaa.org/propulsionenergy}{AIAA Propulsion Energy}.
\end{itemize}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{Turbinecrosssection.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{tempmethodsvenn.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{Single change paints edit.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{multi-change paints edit.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\textwidth]{crystal temp sens.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\textwidth]{tftcNGV.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\textwidth]{kerrpyro.eps}
    \caption{Cross sectional view of pyrometer installation~\cite{Kerr2004}}\label{fig:crosspyro}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=.8\textwidth]{siemens IR edit-01.png}
...
\begin{figure}
    \centering
    \includegraphics[width=.8\textwidth]{yaneztempTBC.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{SAW delay line.png}
    \caption{A SAW delay line~\cite{Ida2014}}\label{fig:sawdelay}
\end{figure}

\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{SAW resonator.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{wedge.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{hertzian.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{willschwaveguide.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{lambwaves2.eps}
    \caption{Particle displacement of symmetric and antisymmetric Lamb wave modes in a plate.}\label{fig:lambwaves}
\end{figure}

\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{inconelyoungsdensitypoisson.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{alutempshift2560.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{phasedispersion.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{grouptemp.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{grouptemp1mhztemp.eps}
...
\chapter{Empirical \& Analytical Studies}\label{results}
...
The values of Young’s modulus produced by this equation have been used to generate temperature dependant dispersion curves for aluminium (Figure~\ref{fig:grouptempshuftalu}). The group velocity of the $S_0$, $A_1$, and $S_1$ modes have been extracted from the curves and used to plot Figure~\ref{fig:alugroupvel}. The temperature sensitivities of the modes are: 1.683--1.728 m s$^{-1}$\si{\degreeCelsius}$^{-1}$ for the $S_0$ mode, 0.928--1.018 m s$^{-1}$\si{\degreeCelsius}$^{-1}$ for the $A_1$ mode, and 1.444--1.548 m s$^{-1}$\si{\degreeCelsius}$^{-1}$ for the $S_0$ mode, over the temperature range 0--100\si{\degreeCelsius} (see Equation~\ref{eqn: eq k}). These values are frequency and mode dependent. The temperature sensitivities increase with temperature, as the mode reduces in frequency (shifts left), and reduces in wave velocity (shifts down). Time of flight ($t_F$) can be calculated from the Equation~\cite{Croxford2007a}:
%
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{grouptempshiftalu.eps}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.8\textwidth]{grouptemp1mhztempalu.eps}
...
\chapter{Simulations}\label{sim}

The multiphysics simulation package COMSOL has been used to simulate the current test setup and will be modified in future studies to investigate the effect of plate holes, curved surfaces, different materials, and alternative transducer configurations.
...
\begin{itemize}
    ...
    \item Verification of the theoretical temperature sensitivities of Lamb wave modes with experimental data. Measurements up to 100\si{\degreeCelsius} in an aluminium plate. Measurements to be extended to higher order modes. This is addressed in Section~\ref{lambtheory}.
...
\begin{itemize}
    \item As the temperature is further increased it will have more of an effect on the operation of transducers. The effect on amplitude and frequency can be investigated.
